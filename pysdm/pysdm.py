...
# Generated on Sat Sep  3 16:24:51 2005
...
class Mainwindow(SimpleGladeApp):
    ...
    def on_remove_fs_button_clicked(self, widget, *args):
        dialog = gtk.Dialog(_("Remove filesystem?"), self.main_widget, gtk.DIALOG_MODAL | gtk.DIALOG_DESTROY_WITH_PARENT, (gtk.STOCK_OK, gtk.RESPONSE_ACCEPT, gtk.STOCK_CANCEL, gtk.RESPONSE_REJECT))
        dialog.vbox.set_border_width(10)
        dialog.vbox.pack_start(gtk.Label(_("This action will delete file system configuration\nAre you sure?")))
        dialog.show_all()
        if dialog.run()==gtk.RESPONSE_ACCEPT:
