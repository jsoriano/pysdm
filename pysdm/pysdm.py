...
# Generated on Fri Aug 26 20:18:45 2005
...
class Mainwindow(SimpleGladeApp):
    ...
    #-- Mainwindow.on_default_button_toggled {
    def on_default_button_toggled(self, widget, *args):
        active = self.get_widget("default_button").get_active()
        if active:
            self.set_options(["defaults"])
        self.get_widget("options_entry").set_sensitive(not active)
        self.get_widget("open_options").set_sensitive(not active)
    #-- Mainwindow.on_default_button_toggled }
